...
namespace coen79_lab8
{
    ...
    public:
        ...
        {
            // STUDENT WORK...
            return (cursor == other.cursor && current_boundary == other.current_boundary && current_block_pointer == other.current_block_pointer && block_pointers == other.block_pointers && block_pointers_end == other.block_pointers_end && first_bp == other.first_bp && last_bp == other.last_bp && front_ptr == other.front_ptr && back_ptr == other.back_ptr && bp_array_size == other.bp_array_size && block_size == other.block_size);
        }
