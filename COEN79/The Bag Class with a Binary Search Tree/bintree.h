...
namespace coen79_lab9
{
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
            // process left node, then current node, then right node
    ...
    {
        // STUDENT WORK
        // process left node, then right node, then current node
    ...
    {
        // STUDENT WORK
        // process current node, then left node, then right node
        f(node_ptr->data());
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
            // copy left and right node
            l_ptr = tree_copy(root_ptr->left());
            r_ptr = tree_copy(root_ptr->right());
            // return new node with copied data and left and right node
    ...
    // Library facilities used: cstdlib
    {
        if (node_ptr == NULL)
            ...
            // STUDENT WORK
            // return size of left node + size of right node + 1
